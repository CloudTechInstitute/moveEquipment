...
if (isset($_POST['addBtn'])) {
    extract($_POST);
    $sql = "INSERT INTO `workers_tbl`(`fname`, `lname`, `staffID`, `address`, `email`, `telephone`, `gender`, `dob`, `duties`, `department`)VALUES('$fname','$lname','$staffId','$address','$email','$tel','$gender','$dob','$duties','$department')";
					...
					<div class="card">
						<div class="card-header pb-0">
							<div class="d-flex align-items-center">
								<p class="mb-0">Add Worker</p>
							</div>
						</div>
						<div class="card-body">
							<form method="post" role="form" action="add-worker.php" enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-4">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="staffId" autocomplete="off" required>
									</div>
								</div>
                                <div class="col-md-3">
									<div class="form-group">
                                ...
                                <div class="col-md-4">
									<div class="form-group">
										<label for="example-text-input" class="form-control-label">Duties</label>
										<input class="form-control" type="text" name="duties" autocomplete="off" required>
									</div>
								</div>
