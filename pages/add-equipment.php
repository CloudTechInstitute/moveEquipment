					...
					<div class="card">
						<div class="card-header pb-0">
							<div class="d-flex align-items-center">
								<p class="mb-0">Add New Equipment</p>
							</div>
						</div>
						<div class="card-body">
							<form method="post" role="form" action="add-equipment.php" enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										<label for="example-text-input" class="form-control-label">Serial Number</label>
										<input class="form-control" type="text" name="serial" autocomplete="off" required>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="example-text-input" class="form-control-label">Oficer In Charge</label>
										<input class="form-control" type="text" name="officer" autocomplete="off" required>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label for="example-text-input" class="form-control-label">Image</label>
										<input class="form-control" type="file" name="equipmentImage" required>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<input class="form-control btn btn-primary" type="submit" value="Add Equipment" name="addBtn">
									</div>
								</div>
							</div>
							</form>
