		...
		<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
			...
			<div class="row">
				...
				<nav aria-label="breadcrumb">
					<h4 class="font-weight-bolder text-white mb-0 text-uppercase">System Users</h4>
								...
								<table class="table align-items-center mb-0">
									<thead>
										<tr>
											...
											<th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">GPS</th>
											<th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Date Enrolled</th>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        ?>
										<tr>
											...
											<td class="align-middle text-center">
												<p class="text-xs font-weight-bold mb-0"><?php echo $row['city']; ?></p>
											</td>
											<td class="align-middle text-center">
												<p class="text-xs font-weight-bold mb-0"><?php echo $row['gps']; ?></p>
											</td>
											<td class="align-middle text-center">
